const en = {
  ...
  membership: {
    ...
    subtitle: "Complete the form below, pay the membership fee, and upload your payment receipt.",
    ...
    paymentIntro:
      "Pay the fee for your selected membership level by bank transfer or Telebirr, then upload the payment invoice or receipt.",
    bankName: "Bank",
